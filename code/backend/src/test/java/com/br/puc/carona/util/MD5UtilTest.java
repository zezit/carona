...
class MD5UtilTest {
    ...
    void shouldReturnTrueForValidMD5Hash() {
        // Valid MD5 hashes
        assertTrue(md5Util.isValidMD5Hash("d41d8cd98f00b204e9800998ecf8427e"));
        assertTrue(md5Util.isValidMD5Hash("5d41402abc4b2a76b9719d911017c592"));
        assertTrue(md5Util.isValidMD5Hash("098f6bcd4621d373cade4e832627b4f6"));
    }
    ...
    void shouldReturnFalseForInvalidMD5Hash(final String input) {
        assertFalse(md5Util.isValidMD5Hash(input));
    }
