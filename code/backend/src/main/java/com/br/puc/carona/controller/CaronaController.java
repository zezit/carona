...
public class CaronaController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Carona criada com sucesso", content = {
                                        ...
                                        examples = {
                                            @ExampleObject(
                                                name = "Carona criada com sucesso",
                                                description = "Exemplo de resposta de carona criada",
                                                value = """
                                                {
                                                    "id": 1,
                                                    "motorista": {
        ...
        public ResponseEntity<CaronaDto> criarCarona(
                        @Valid @io.swagger.v3.oas.annotations.parameters.RequestBody(
                            content = @Content(
                                ...
                                schema = @Schema(implementation = CaronaRequest.class),
                                examples = {
                                    @ExampleObject(
                                        name = "Requisição de Carona", 
                                        description = "Modelo de requisição para criar uma nova carona", 
                                        value = """
                                        {
                                            "pontoPartida": "Rua A, 123",
                                            "latitudePartida": -23.5505,
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Carona encontrada", content = {
                                        ...
                                        examples = {
                                            @ExampleObject(
                                                name = "Carona encontrada",
                                                description = "Exemplo de resposta de busca de carona",
                                                value = """
                                                {
                                                    "id": 1,
                                                    "motorista": {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de caronas obtida com sucesso", content = {
                                        ...
                                        examples = {
                                            @ExampleObject(
                                                name = "Lista de caronas do motorista",
                                                description = "Exemplo de resposta com lista paginada de caronas",
                                                value = """
                                                {
                                                    "content": [
                                                        {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Carona atualizada com sucesso", content = {
                                        ...
                                        examples = {
                                            @ExampleObject(
                                                name = "Carona atualizada com sucesso",
                                                description = "Exemplo de resposta após atualização de uma carona",
                                                value = """
                                                {
                                                    "id": 1,
                                                    "motorista": {
        ...
        public ResponseEntity<CaronaDto> atualizarCarona(@PathVariable Long id,
                        @Valid @io.swagger.v3.oas.annotations.parameters.RequestBody(
                            content = @Content(
                                ...
                                examples = {
                                    @ExampleObject(
                                        name = "Requisição de Atualização de Carona", 
                                        description = "Modelo de requisição para atualizar uma carona existente", 
                                        value = """
                                        {
                                            "pontoPartida": "Rua C, 789",
                                            "latitudePartida": -23.5550,
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Status da carona alterado com sucesso", content = {
                                        ...
                                        examples = {
                                            @ExampleObject(
                                                name = "Status alterado para EM_ANDAMENTO",
                                                description = "Exemplo de resposta após alteração do status para EM_ANDAMENTO",
                                                value = """
                                                {
                                                    "id": 1,
                                                    "motorista": {
